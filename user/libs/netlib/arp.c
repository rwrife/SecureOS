/**
 * @file arp.c
 * @brief ARP request/reply and address cache for the shared netlib stack.
 *
 * Purpose:
 ...
 *
 * Interactions:
 *   - eth.c sends ARP packets as Ethernet frames with EtherType 0x0806.
 *   - ipv4.c calls arp_resolve() before building each IP packet and forwards
