...
| `launch.granted` / `launch.denied` (`owner_kind=...`) | Launcher execution-decision audit | Launcher execute/deny decision path (`kernel/user/launcher_exec.c`) | `launcher_owner_kind_audit_marker` (host contract pin) + `toolchain_launch_audit_owner_kind_field_emitted` (QEMU SKIP-pinned until #410) | [`launch-audit-contract.md`](launch-audit-contract.md) | [#554](https://github.com/rwrife/SecureOS/issues/554) |
...
Last verified against commit: 593e9344acd62ca5c9d15f558bacc5fd50268784
