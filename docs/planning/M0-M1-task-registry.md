...
| M1-CAP-018 | M1 | Enforce capability audit checkpoint summary contract in validator artifacts | M1-CAP-017 | `./build/scripts/validate_bundle.sh` | done |
| M1-CAP-019 | M1 | Sequence-window attestation across capability audit/checkpoint summaries | M1-CAP-018 | `./build/scripts/validate_bundle.sh` | todo |
