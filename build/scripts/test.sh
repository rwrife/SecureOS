...
usage() {
  cat <<EOF
Usage: $(basename "$0") [hello_boot|hello_boot_negative|cap_api_contract|capability_table|capability_gate|capability_audit|event_bus|scheduler|tls|https|bearssl_compile|fs_service|app_runtime|kernel_console|kernel_filedemo|kernel_persistence|kernel_sessions]
