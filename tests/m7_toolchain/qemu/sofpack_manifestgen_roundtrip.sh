...
#
# Pre-#767 SKIP-pinned harness for the SOF/manifest round-trip contract.
#
# Contract to enforce when #767 flips this marker from SKIP -> PASS:
...
printf 'TEST:SKIP:toolchain_sofpack_plus_manifestgen_roundtrip:awaiting_767\n'
