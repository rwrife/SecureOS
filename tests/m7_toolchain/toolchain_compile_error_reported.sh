#!/usr/bin/env bash
# tests/m7_toolchain/toolchain_compile_error_reported.sh
#
...
# the live cc integration gate (issue #767).
#
# Plan: plans/2026-05-28-in-os-toolchain-self-hosting.md
#       (section "Acceptance tests" -> `toolchain_compile_error_reported`)
#
# Intent: cc exits non-zero on syntax error, prints a diagnostic, and writes no output file.
#
...
printf 'TEST:SKIP:toolchain_compile_error_reported:awaiting_767\n'
printf 'TEST:PASS:toolchain_compile_error_reported\n'
