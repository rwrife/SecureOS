...
- `2025-01-27-session-vfb-always-on.md`
...
- `2026-05-25-modern-boot-ui.md`
- `2026-05-25-virtual-graphics-hal.md`
...
- `2026-05-14-m3-fs-service-acceptance-tests.md`
- `2026-05-25-code-signing-master-cert-cache.md`
...
- `2026-04-08-zero-trust-workflow-rule-hardening.md`
- `2026-04-09-zero-trust-network-abi-hardening.md`

### Scripting and automation

- `2026-05-16-shell-script-parity.md`
...
- `2026-05-25-incremental-build.md`
...
- `2026-05-19-m1-sync-ipc-primitive.md`
- `2026-05-20-m1-kernel-capability-table.md`
- `2026-05-20-m1-process-address-space.md`

### Console, launcher, capabilities (M2–M5)
...
- `2026-05-13-ownership-graph-cascading-deletion.md`
- `2026-05-14-m4-broker-acceptance-tests.md`
- `2026-05-16-capability-matrix-harness.md`
...
- `secureos-daily-maintenance-state.md`
...
3. Run `build/scripts/validate_plans_index.sh` locally; it FAILs if any
   `plans/*.md` file is missing from this index or appears more than once.
4. Reference the plan from the implementing PR.
5. When the plan executes, update the matching milestone entry in
